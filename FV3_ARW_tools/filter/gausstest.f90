...
integer i,j
! matrix A
  data (a(1,i), i=1,5) /  0.0,  1.0,  2.0, 3.0, 4.0 /
  data (a(2,i), i=1,5) /  2.0,  1.0,  4.0, 1.0, 2.0 /
  data (a(3,i), i=1,5) /  2.0,  4.0,  6.0, 4.0, 3.0 /
  data (a(4,i), i=1,5) /  1.0,  2.0,  7.0, 2.0, 1.0 /
  data (a(5,i), i=1,5) /  0.5,  3.0,  4.0, 2.0, 1.0 /
! matrix b
  data (b(i),   i=1,5) /  4.0,  3.0,  7.0, 3.0, 4.0 /
